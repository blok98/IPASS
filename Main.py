...
os.chdir("C:\\Users\\tom_s\\Desktop\\code")
...
# capital=1000
# for i in range(len(match_test)):
#     returnFactor=official_returns[i]
#     HTmorelikelytowin_official=official_odds[i]
#     HTmorelikelytowin_estimated=estimated_odds[i]
#     won=match_test[i].won
#     capital-=100
#     if won==1:
#         print("team won, look:",match_test[i].__dict__)
#         capital+=returnFactor*100
#     print(capital)
